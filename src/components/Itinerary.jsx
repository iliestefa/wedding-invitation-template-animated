...
export default function Itinerary() {
  ...
  const items = [
    { time: "18:00", name: t.ceremony, icon: "rings" },
    { time: "19:00", name: t.cocktail, icon: "cheers" },
    { time: "19:45", name: t.firstDance, icon: "music" },
    { time: "20:00", name: t.dinner, icon: "dinner" },
    { time: "21:00 – 00:00", name: t.party, icon: "party" },
  ];
