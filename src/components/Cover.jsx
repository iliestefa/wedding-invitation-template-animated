...
export default function Cover({ progress }) {
  ...
  return (
    <div className="cover-envelope" style={{ opacity: envOp }}>
      ...
      <div className="env-box">
        ...
        <div className="env-body">
          ...
          <svg className="env-folds" viewBox="0 0 420 280" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Líneas de pliegue */}
            <line x1="0"   y1="0"   x2="210" y2="168" stroke="#b8b09c" strokeWidth="0.7" opacity="0.6"/>
            <line x1="420" y1="0"   x2="210" y2="168" stroke="#b8b09c" strokeWidth="0.7" opacity="0.6"/>
            <line x1="0"   y1="280" x2="210" y2="168" stroke="#b8b09c" strokeWidth="0.7" opacity="0.6"/>
            <line x1="420" y1="280" x2="210" y2="168" stroke="#b8b09c" strokeWidth="0.7" opacity="0.6"/>
          </svg>

          {/* Texto centrado en el cuerpo */}
          <div className="env-txt" style={{ opacity: textOp }}>
            <div className="env-mono gv">B &amp; R</div>
            <div className="env-names">
              <span className="gv env-n">Braydon</span>
              <span className="env-a">&amp;</span>
              <span className="gv env-n">Reli</span>
            </div>
            <div className="env-d">10 · 10 · 2026</div>
          ...
          <div className="env-flap" style={{ transform: `rotateX(${flapDeg}deg)` }}>
            ...
            >
              <defs>
                ...
                <filter id="fsh">
                  <feDropShadow dx="0" dy="4" stdDeviation="8" floodColor="#2a3010" floodOpacity="0.35"/>
                </filter>
              </defs>
              <path d="M0 0 L420 0 L210 190 Z" fill="url(#fg)" filter="url(#fsh)" />
              {/* Borde de la solapa */}
              <path d="M0 0 L420 0 L210 190 Z" fill="none" stroke="#7a855f" strokeWidth="0.8" opacity="0.6"/>

              {/* Sello de cera */}
              <g style={{ opacity: sealOp }}>
                <circle cx="210" cy="82" r="32" fill="#6b7550" />
                <circle cx="210" cy="82" r="27" fill="none" stroke="rgba(255,255,255,0.25)" strokeWidth="1.2"/>
                <circle cx="210" cy="82" r="22" fill="none" stroke="rgba(255,255,255,0.15)" strokeWidth="0.7"/>
                <text x="210" y="90" textAnchor="middle"
      ...
      {/* Hint scroll */}
      <div className="env-hint" style={{ opacity: progress < 0.08 ? 1 : Math.max(0, 1 - (progress - 0.08) / 0.08) }}>
